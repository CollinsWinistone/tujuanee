...
include 'email-server.php';//email server credentials
...
if (isset($_POST['reset-request-submit']))
{
    ...
    $url = $Domain . "/cosa/create-new-pwd.php?selector=" . $selector . "&validator=" . bin2hex($token);
    ...
    $message = '<p>We received a password reset request. The link to your password is below.'
            ...
            . '<p><b><i>Here is your password reset link: </i></b></br>'
            . $reset_link. $reset_name  . '</a></p>';
