...
?>  
    ...
    <body style="background: #f1f1f1">
        ...
        <?php
            ...
            //check if category is available in the get request
            if(isset($_GET['cat']))
            {
      ...
      <div class="d-flex align-items-center p-3 my-3 text-white-50 bg-purple rounded shadow-sm">
        ...
        <div class="lh-100">
          <h1 class="mb-0 text-white lh-100">Cosa Forums</h1>
                ...
                while ($row = mysqli_fetch_assoc($result))
                {
                    ...
                    echo '<a href="posts.php?topic='.$row['topic_id'].'">
                        <div class="media text-muted pt-3">
                            <img src="img/google_forums.jpg" alt="" class="mr-2 rounded div-img">
                    ...
                    //only allow administartors to delete forums if they need
