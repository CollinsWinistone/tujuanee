 ...
 */
    ...
    define('TITLE',"Cosa Forums");

    /*
    *Check if user is logged in
    *if yes redirect to login.php page
    */
        ...
        <div class="my-3 p-3 bg-white rounded shadow-sm">
            ...
            else
            {
                ...
                while ($row = mysqli_fetch_assoc($result))
                {
                    ...
                    /**
                     * If user is admin,
                     * Allow him or her to delete unwanted categories 
                     * Of their wish
                    */
           ...
           /**
            * if user is admin,
            *Allow him/her to create a new category
            */
            if ($_SESSION['userLevel'] == 1)
            {
        ...
        <div class="my-3 p-3 bg-white rounded shadow-sm">
            ...
            else
            {
                ...
                while ($row = mysqli_fetch_assoc($result))
                {
                    ...
                    /**
                     * if user is admin,
                     * Allow them to delete forums they wish
                     */
