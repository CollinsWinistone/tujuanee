 ...
 */
    ...
    session_start();
    include_once 'includes/dbh.inc.php';//database file
    define('TITLE',"Cosa");

    $companyName = "Cosa World";

    /*
    *strips bad characters and replaces them with whitespace
    */
    function strip_bad_chars( $input ){
        //replace any characters which dont match the pattern
...
?>
    ...
    <body onload="pageLoad()">
        ...
        <img src='img/cosa2.png' id='loader-logo'>
            <div class="loader">
                ...
                <div class="row">
                  ...
                  <!--end of profile div-->
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade show active" id="forum" role="tabpanel" aria-labelledby="forum-tab">
                                ...
                                <div class="d-flex align-items-center p-3 my-3 text-white-50 bg-purple rounded shadow-sm">
                                    <img class="mr-3" src="img/cosa2.png" alt="" width="48" height="48">
                                  <div class="lh-100">
                                            ...
                                            while ($row = mysqli_fetch_assoc($result))
                                            {
                                                echo '<div class="col-md-6">
                                                        ...
                                                        <img class="card-img-left flex-auto d-none d-lg-block blogindex-cover"
                                                                src="img/google_forums.jpg" alt="Card image cap">
                                                                </a>
                    ...
                    <div class="col-sm-2">
                        ...
                        <a href="forum.php" class="btn btn-warning btn-lg btn-block">Cosa Forum</a>
                        <a href="hub.php" class="btn btn-secondary btn-lg btn-block">Cosa Hub</a>
                        <br><br><br>
