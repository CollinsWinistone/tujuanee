...
/**
 * Displays all the users using the site
        ...
        <main role="main" class="container">
            <div class="mx-5">
                <div class="d-flex align-items-center p-3 my-3 mx-5 text-white-50 bg-purple rounded shadow-sm">
                  ...
                  <div class="lh-100">
                    <h1 class="mb-0 text-white lh-100">Cosa Users</h1>
                    <small>Spreading Ideas</small>
                  </div>
                </div>

                <div class="my-3 mx-5 p-3 bg-white rounded shadow-sm">
                  <h5 class="border-bottom border-gray pb-2 mb-0">Find People on Cosa</h5>
