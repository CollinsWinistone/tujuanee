 ...
 */
    ...
    define('TITLE',"Reset Password | Cosa");
    ...
    <main role="main" class="container mt-5">
        ...
        ?>
            ...
            <form action="includes/reset-password.inc.php" method="post" id="contact-form">
                ...
                <br><br>
                <div class="form-row">
                    <input class="btn btn-secondary btn-lg btn-block" type="submit" class="button next"
                        name="reset-password-submit" value="Reset Password">
                </div>
